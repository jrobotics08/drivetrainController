...
int main() {
  ...
  int accelerationValue;
   ...
   leftMotorA.setMaxTorque(50,percent);
   rightMotorA.setMaxTorque(50,percent);

   leftMotorB.setMaxTorque(50,percent);
   rightMotorB.setMaxTorque(50,percent);
  
  while(true)
  {
    accelerationValue = Controller1.Axis3.position();
